...
const Dashboard: React.FC = () => {
    const { totalValue, totalCost, totalPL, todaysPL, lastUpdated, loading } = usePortfolio();
    ...
    return (
        <div className="mb-0">
            {lastUpdated && (
                <div className="flex justify-end items-center text-xs text-slate-500 mb-2">
                    <span>
                    ...
                    {loading && <span className="ml-2 text-blue-500 animate-pulse font-medium">(Syncing...)</span>}
                </div>
            )}
